...
const Hotel = () => {
  ...
  const [openReserver, setOpenReserve] = useState(false);
  ...
  const handleMove = (direction) => {
    ...
    if (direction === "l") {
      newSlideNumber =
        slideNumber === 0 ? data.photo.length - 1 : slideNumber - 1;
    } else {
      newSlideNumber =
        slideNumber === data.photo.length - 1 ? 0 : slideNumber + 1;
    }
          ...
          <div className="hotelWrapper">
            ...
            <div className="hotelDetails">
              ...
              <div className="hotelDetailsPrice">
                ...
                <h2>
                  <b>Rs {data.cheapestPrice * days * options.room}</b> ({days}{" "}
                  nights)
                </h2>
                <button onClick={handleOnClick}>Reserve or Book Now!</button>
              </div>
            </div>
            {openReserver && <Reserve setOpen={setOpenReserve} hotelId={id} />}
          </div>
        )}
      </div>
      <MailList />
